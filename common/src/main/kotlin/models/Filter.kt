 ...
 */
@Serializable
data class Filter(@Serializable(with = LocalDateTimeIso8601Serializer::class) var edtStartDateRange: LocalDateTime? = null, @Serializable(with = LocalDateTimeIso8601Serializer::class) var edtEndDateRange: LocalDateTime? = null, var isCompleted: Boolean? = null, var priorities: MutableList<Priority> = mutableListOf(), var labelIds: MutableList<Int> = mutableListOf(), var id: Int = 0) {
    /*
