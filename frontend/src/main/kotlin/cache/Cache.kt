...
*/
class Cache(private val windowSettingsFilePath: String = "window_settings.json", private val groupToItemOrderingFilePath: String = "group_id_to_item_id_ordering.json") {
